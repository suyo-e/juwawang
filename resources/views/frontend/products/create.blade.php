...
<script src="https://cdn.staticfile.org/plupload/3.1.0/plupload.min.js"></script>
<script type="text/javascript" src="/js/bower_components/plupload/js/moxie.js"></script>
<script type="text/javascript" src="/js/bower_components/plupload/js/plupload.dev.js"></script>
<!-- <script type="text/javascript" src="/js/bower_components/plupload/js/plupload.full.min.js"></script> -->
<script type="text/javascript" src="/js/bower_components/plupload/js/i18n/zh_CN.js"></script>
...
$(function() {
    ...
    var uploader = Qiniu.uploader({
        ...
        domain: 'http://juwa-cdn.tupppai.com/',   //bucket 域名，下载资源时用到，**必需**
